...
--
-- Host: localhost
-- Generation Time: Dec 01, 2016 at 04:25 
...
(2, 'Departamento de seguridad', 'Departamento para el control de normas');
...
INSERT INTO `persona` (`id`, `departamento_id`, `nombres`, `apellidos`, `cedula`) VALUES
(1, 1, '1', 'apellidos de superadmin', '0802969978'),
(2, 1, '3', 'gonzalez', '0802969964'),
(3, 1, '3', 'landazuri', '0802966965'),
(4, 2, '11', 'portocarrero', '0802658871');
...
(11, '_KAovVw5qhPB8XUhilqF866_75Zs0cTB', 1480388862, 0);
...
(11, 'user2', 'otrousuario@gmail.com', '$2y$12$/yNpbYI12BC1E/hUwmbuH.Ebr7OMK8KKBo330KhZzr3ixs7/nX/Za', 'MfI9PqNvA2eLNnK3c60WSU3_C_Xc-S7m', 1480388915, NULL, NULL, '127.0.0.1', 1480388862, 1480388862, 0, 0);
